...
This project was done independently while following the course _Lambda Calculus and Type Systems_ by [Uwe Nestmann](https://www.mtv.tu-berlin.de/nestmann). The course, and in turn this project, is based on, and many of the algorithms taken from: 
- Henk P Barendregt. Lambda calculi with types. In S. Abramsky, D.M. Gabbai, and T.S.E. Maibaum, editors, Handbook of logic in computer science (vol. 2), pages 117–309. Oxford University Press, 1992.
